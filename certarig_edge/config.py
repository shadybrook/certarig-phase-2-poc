    ...
    for index, item in enumerate(channels_raw):
        ...
        channels.append(
            ChannelConfig(
                ...
                engineering_min=float(item["engineering_min"]) if item.get("engineering_min") is not None else None,
                engineering_max=float(item["engineering_max"]) if item.get("engineering_max") is not None else None,
            )
        )
