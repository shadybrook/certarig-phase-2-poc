...
from certarig_edge.hardware.raspberry_pi import RaspberryPiHardware
from certarig_edge.models import HardwareConfig, RigConfig
...
class RaspberryPiHardwareTests(unittest.TestCase):
    def build(self, active_high: bool = True) -> RaspberryPiHardware:
        ...
        with patch.dict(sys.modules, {"gpiozero": fake_gpiozero}), patch(
            "certarig_edge.hardware.raspberry_pi.ADS1115Reader", FakeADC
        ):
    ...
    def test_fail_safe_nc_loop_low_is_healthy_and_high_is_active(self) -> None:
        ...
        hardware.emergency_stop.value = 0
